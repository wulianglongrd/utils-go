...
// Write wraps the Hash.Write function,
...
// WriteString wraps the Hash.WriteString function,
// Hash.WriteString error always return nil, this func simplify caller handle error
